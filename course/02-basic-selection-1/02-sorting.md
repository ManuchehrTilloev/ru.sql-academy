...
| NULL значения | `NULL` значения идут первыми                                                                                                                          | `NULL` значения идут последними                                                                                                 |
...
Интерактивная демонстрация доступна [в уроке на SQL Academy](https://sql-academy.org/ru/guide/sorting).
